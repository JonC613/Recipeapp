...
title: Recipeapp
description: Personal, mobile-first Recipe Library application with manual recipes, URL, text, and retained PDF imports, optional OCR for scanned PDFs, and explicit import review and saving.
status: stable
...
explicit OCR fallback for scanned documents. Every import converges on review and explicit save,
built on the responsive application foundation and safe Worker-owned Cloudflare service boundaries.
...
- Application authentication, standalone image/screenshot import, and broader ingredient, tag,
  category, or semantic search are not implemented.
