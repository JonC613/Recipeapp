...
import { createRecipeChatConversation, deleteRecipeChatConversation, getRecipeChatConversation, listRecipeChatConversations, resolveRecipeChatProposal, streamRecipeChatMessage } from '../services/recipe-chat.js'
...
export function RecipeChatPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    controller.current = new AbortController(); setError(undefined); setDraft(''); setProgress('Starting…')
    try {
      await streamRecipeChatMessage(active.id, normalized, (streamEvent: RecipeChatStreamEvent) => {
