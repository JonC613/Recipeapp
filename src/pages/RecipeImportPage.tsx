...
import { importRecipeText, importRecipeUrl } from '../services/imports'
export function RecipeImportPage() { return <section className="recipe-page"><p className="eyebrow">Recipe import</p><h1>Import a recipe</h1><h2>Paste a recipe URL</h2><UrlImportForm onImport={importRecipeUrl} /><h2>Paste recipe text</h2><TextImportForm onImport={importRecipeText} /><Link to="/recipes/new">Enter a recipe manually</Link></section> }
