...
import { RecipeDiscoveryBetaPage } from '../pages/RecipeDiscoveryBetaPage'

export const router = createBrowserRouter([{ path: '/', Component: AppShell, errorElement: <RouteErrorPage />, children: [
  { index: true, Component: RecipeLibraryPage }, { path: 'meal-plan', Component: MealPlanPage }, { path: 'recipes/chat', Component: RecipeChatPage }, { path: 'beta/discover', Component: RecipeDiscoveryBetaPage }, { path: 'recipes/new', Component: RecipeEditorPage }, { path: 'recipes/import', Component: RecipeImportPage }, { path: 'recipes/mealdb', Component: MealDbBrowsePage }, { path: 'admin/usage', Component: UsageDashboardPage }, { path: 'imports/:importId/review', Component: RecipeImportReviewPage }, { path: 'imports/:importId', Component: RecipeImportResultPage }, { path: 'recipes/:recipeId/edit', Component: RecipeEditorPage }, { path: 'recipes/:recipeId/cook', Component: CookingModePage }, { path: 'recipes/:recipeId', Component: RecipeDetailPage }, { path: '*', Component: NotFoundPage },
] }])
